var setup = function () {
    ...
    var loadForm = function (formId) {
        ...
        $.ajax({
            type: 'POST',
            url: 'http://localhost:53126/FormsService.asmx/LoadForm',
            ...
            success: function (response) {
                try {
                    ...
                    var config = JSON.parse(form.formdata);
    ...
    var saveForm = function (orgId,config) {
       
        $.ajax({
            type: 'POST',
            url: 'http://localhost:53126/FormsService.asmx/SaveForm',
            data: JSON.stringify({ orgId: orgId, data: config }),
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success: function (response) {
    ...
    $(".test-button").off().click(function(){
